...
interface MediumDefaultRegularButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children?: React.ReactNode;
}

export default function MediumDefaultRegularButton({ children, className, ...props }: MediumDefaultRegularButtonProps) {
  return (
    <Button
      className={cn(
