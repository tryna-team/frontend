...
interface MediumDefaultFitButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children?: React.ReactNode;
}

export default function MediumDefaultFitButton({ children, className, ...props }: MediumDefaultFitButtonProps) {
  return (
    <Button
      className={cn(
