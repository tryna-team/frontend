...
interface LargeStrongRegularButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children?: React.ReactNode;
}

export default function LargeStrongRegularButton({ children, className, ...props }: LargeStrongRegularButtonProps) {
  return (
    <Button
      className={cn(
