...
interface LargeDefaultFullButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children?: React.ReactNode;
}

export default function LargeDefaultFullButton({ children, className, ...props }: LargeDefaultFullButtonProps) {
  return (
    <Button
      className={cn(
