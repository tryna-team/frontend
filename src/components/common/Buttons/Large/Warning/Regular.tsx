...
interface LargeWarningRegularButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children?: React.ReactNode;
}

export default function LargeWarningRegularButton({ children, className, ...props }: LargeWarningRegularButtonProps) {
  return (
    <Button
      className={cn(
