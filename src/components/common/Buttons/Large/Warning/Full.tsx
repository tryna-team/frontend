...
interface LargeWarningFullButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children?: React.ReactNode;
}

export default function LargeWarningFullButton({ children, className, ...props }: LargeWarningFullButtonProps) {
  return (
    <Button
      className={cn(
