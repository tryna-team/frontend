...
interface BrandButtonMediumProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children?: React.ReactNode;
}

export default function BrandButtonMedium({ children, className, ...props }: BrandButtonMediumProps) {
  return (
    <Button
      className={cn(
